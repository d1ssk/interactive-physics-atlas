# Pyodide browser-compute subset
...
Only the files required to start Pyodide and load NumPy are retained. This
subset runs the versioned Lie computation kernel in a Web Worker; individual
operations, such as weight diagrams and bounded tensor products, are supplied
by visualization-specific kernel wheels rather than vendored into Pyodide.
The package lock records NumPy wheel SHA-256

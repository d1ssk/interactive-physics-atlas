...
FIELDS = (
    ...
    FieldDefinition(
        ...
        "熱力学",
        "平衡、熱、仕事、エントロピー、熱力学ポテンシャルを探究します。",
    ),
    FieldDefinition(
        "statistical-physics",
        "Statistical Physics",
    ...
    FieldDefinition(
        ...
        "物理学のための数学",
        "物理学のさまざまな分野で用いられる数学的構造と手法を探究します。",

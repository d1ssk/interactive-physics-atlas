...
def test_field_catalog_uses_agreed_labels() -> None:
    ...
    assert FIELD_BY_SLUG["thermodynamics"].image == "assets/images/thermodynamics.png"
    assert FIELD_BY_SLUG["statistical-physics"].image == "assets/images/statistical-physics.png"
    assert (
        FIELD_BY_SLUG["condensed-matter-physics"].image
    ...
    assert FIELD_BY_SLUG["fluid-mechanics"].image == "assets/images/fluid-mechanics.png"
    ...
    assert FIELD_BY_SLUG["quantum-field-theory"].image == "assets/images/quantum-field-theory.png"

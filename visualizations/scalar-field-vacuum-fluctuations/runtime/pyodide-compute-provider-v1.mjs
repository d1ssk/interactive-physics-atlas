/** Lazy, bounded Worker provider for versioned scalar-vacuum calculations. */
...
export class PyodideComputeProvider {
  ...
  constructor({
    ...
    workerFactory = url => new Worker(url, {type:"module", name:"scalar-vacuum-kernel"}),
    now = () => performance.now(),
  ...
  compute(request, {onPhase} = {}) {
    ...
    return new Promise(resolve => {
      ...
      this.#active = {request, resolve, onPhase, cacheKey, timer, startedAt};
      try {

...
const MESSAGES = {
  en: {
    ...
    transitionTick: "1 · transition",
    sshBandStructure: "SSH BAND STRUCTURE",
    dVectorTrajectory: "d-VECTOR TRAJECTORY",
    originWindingTest: "ORIGIN = WINDING TEST",
    finiteChainFlow: "FINITE-CHAIN SPECTRAL FLOW",
    twelveCells: "12 UNIT CELLS",
    realSpaceProfile: "REAL-SPACE PROFILE",
    eighteenCells: "18 UNIT CELLS",
  ...
  ja: {
    ...
    windingTitle: "SSH 模型の 1次元 winding",
    ...
    winding: "WINDING",
    moveAlongK: "k に沿って移動",
    transitionTick: "1 · 相転移",
    sshBandStructure: "SSH バンド構造",
    dVectorTrajectory: "d ベクトルの軌道",
    originWindingTest: "原点 = WINDING 判定",
    finiteChainFlow: "有限鎖のスペクトルフロー",
    twelveCells: "12 単位胞",
    realSpaceProfile: "実空間プロファイル",
    eighteenCells: "18 単位胞",
    ...
    torusAria: "Bloch ベクトルの向きで着色した 3次元 Brillouin torus。ドラッグで回転できます",

...
const MESSAGES = {
  ...
  ja: {
    ...
    challengeTitle: "チャレンジ：{type}を構成", invalidTitle: "有限型Dynkin図形ではありません",
    invalidSuffix: " 元に戻すか、選択した辺を編集してください。", solvedTitle: "{type}を完成",
    solvedStatus: "正解です。単純ルートの番号を付け替えると、Cartan行列は{type}と同値です。",
    wrongChallenge: "有限型{name}ですが、現在のチャレンジは{type}です。",
    semisimple: "すべての連結成分が有限型なので、これは半単純積です。",
    connectedFinite: "連結な有限結晶型Dynkin図形です。",
    cycle: "基礎グラフに閉路があります。連結な有限型Dynkin図形はすべて木です。",
    degree: "次数4以上のノードがあります。有限型Dynkin図形には現れません。",
    multiple: "連結な有限型Dynkin図形に含まれる多重辺は高々1本です。",
    ...
    noMatch: "得られたCartan行列は全階数8までの有限型と一致しません。",
...
function localizeStaticContent() {
  ...
  const aria = {
    ".workspace": "Dynkin図形エディター", ".toolbar": "編集ツール",
    '[aria-label="Pointer mode"]': "ポインターモード", '[aria-label="Edit selection"]': "選択対象の編集",
    '[aria-label="Edit history"]': "編集履歴", "#diagram": "編集可能なDynkin図形キャンバス",
    ".results": "分類結果",
  };

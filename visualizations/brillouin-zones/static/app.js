...
(() => {
  const TRANSLATIONS = {
    ...
    ja: {
      ...
      zoneVolume: "Brillouin zone の体積", loading: "3次元プロットを読み込んでいます…",
      loadError: "3次元プロットを読み込めませんでした。",
      plotsLabel: "実空間と逆空間のプロット", realCaption: "実空間",
      reciprocalCaption: "逆空間と第一 Brillouin zone", realPlotLabel: "実空間の結晶格子の 3次元表示",
      reciprocalPlotLabel: "逆格子と第一 Brillouin zone の 3次元表示",
